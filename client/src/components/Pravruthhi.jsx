    ...
    <html lang="en">
        ...
        <style>
          {`
            body {
              ...
              color: #070707;
              line-height: 1.6;
              background: url('./assets/prav_bg.jpeg.jpg') center/cover no-repeat fixed;
              padding: 60px;
              position: relative;
            }
            h1, h2 {
      ...
      <body>
        <div className="club">
          ...
          <img src= './assets/pravruthhi_logo.jpeg.jpg' alt="Pravrutthi Theatre Club" height="20" />
